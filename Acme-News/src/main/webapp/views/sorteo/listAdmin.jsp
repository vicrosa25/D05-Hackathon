...
<display:table name="sorteos" id="row" requestURI="sorteo/admin/listAdmin.do" pagesize="5" class="displaytag">
	...
	<display:column property="fechaVencimiento" title="${fechaVencimientoHeader}" sortable="false"/>
	
	
	<display:column><a href="sorteo/admin/displayAdmin.do?sorteoId=${row.id}">
