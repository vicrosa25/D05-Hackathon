...
<display:table name="premios" id="row" requestURI="premio/admin/list.do" pagesize="5" class="displaytag">
	...
	<display:column><a href="premio/admin/display.do?premioId=${row.id}">
