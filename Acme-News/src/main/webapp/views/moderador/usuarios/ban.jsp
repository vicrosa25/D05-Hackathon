...
<display:table name="usuariosToBan" id="row" requestURI="moderador/usuarios/ban.do" pagesize="5" class="displaytag">
	...
	<display:column>
	 <form:form action="moderador/usuarios/ban.do?usuarioId=${row.id}">
...
<display:table name="usuariosToUnban" id="row" requestURI="moderador/usuarios/ban.do" pagesize="5" class="displaytag">
